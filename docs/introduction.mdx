...
<CardGroup cols={2}>
  ...
  <Card title="AI CLI Tools" icon="brain" href="/docs/ai-cli-tools">
    Qwen Code, Gemini CLI, OpenCode, Kilo, Mistral Vibe, Codex, Copilot — all on your phone.
  </Card>
...
| **7 AI CLIs** | Qwen Code, Gemini CLI, OpenCode, Kilo, Mistral Vibe, Codex, GitHub Copilot |
...
Android Device (Termux)
  ...
  OpenClaw Gateway
  ┌─────┴──────┐
  │  AI CLIs   │  ◄── Qwen, Gemini, OpenCode, Kilo, Vibe, Codex, Copilot
