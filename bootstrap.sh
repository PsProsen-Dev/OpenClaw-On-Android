#!/usr/bin/env bash
# bootstrap.sh - Download and run OCA (OpenClaw on Android) installer
# Usage: curl -sL https://raw.githubusercontent.com/PsProsen-Dev/OpenClaw-On-Android/master/bootstrap.sh | bash
set -euo pipefail
...
echo ""
echo -e "${BOLD}OCA — OpenClaw on Android - Bootstrap${NC}"
echo ""
